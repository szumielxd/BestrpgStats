...
public class Config {
	...
	/**
	 * Get value of given key parsed as object
	 * 
	 * @param key the key
	 * @return value of given key
	 */
	public @NotNull Object get(@NotNull ConfigKey key) {
		return this.yaml.isSet(key.getPath()) ? this.yaml.get(key.getPath()) : key.getDefault();
	}
